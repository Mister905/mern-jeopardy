            ...
            <div className="row">
              <div className="col m4 offset-m4">
                {/* <Modal
                  ...
                  trigger={
                    <Button className="btn btn-large btn-wide btn-custom waves-effect waves-jeopardy-blue bold-text btn-delete-account">
                      <i class="material-icons delete-account-icon">delete_forever</i>
                      Delete Account
                    </Button>
                  }
                  actions={
