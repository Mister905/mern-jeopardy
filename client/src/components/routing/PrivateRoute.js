...
const PrivateRoute = ({ component: Component, auth: { is_authenticated, loading }, ...rest }) => (
    <Route {...rest} render={props => !is_authenticated && !loading ? (<Redirect to='/login' />) : (<Component {...props} />) } />
)
